...
@pytest.mark.skipif(
    sys.platform == "darwin" or not _transformers_installed or platform.machine() == "ARM64",
    reason="do not run on mac os, transformers not installed, or arm64 machine (datasets not available)",
)
